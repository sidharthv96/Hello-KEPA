...
import com.sidharth.hellokpa.CategoryFragment.OnListFragmentInteractionListener;
import com.sidharth.hellokpa.dummy.Category.CategoryItem;
...
public class MyCategoryRecyclerViewAdapter extends RecyclerView.Adapter<MyCategoryRecyclerViewAdapter.ViewHolder> {
    ...
    public MyCategoryRecyclerViewAdapter(List<CategoryItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
